...
- Per @.agent/rules/constitution.md "Always paste terminal output when reporting test results — no unsupported claims," paste the actual stdout/stderr in your response and in `_artifacts/<chat-slug>/walkthrough.md`.
